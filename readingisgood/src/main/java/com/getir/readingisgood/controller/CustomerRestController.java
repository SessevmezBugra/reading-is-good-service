...
public class CustomerRestController {
    ...
    public ResponseEntity<RestResponse<TokenDto>> login(@RequestBody LoginDto loginDto) {
        ...
        return ResponseEntity.ok(RestResponse.of(new TokenDto(loginDto.getEmail(), token)));
    }

    @RequestMapping(value = "/register", method = RequestMethod.POST)
    public ResponseEntity<RestResponse<Void>> register(@RequestBody RegistrationDto registrationDto) {
         userService.register(registrationDto);
         return ResponseEntity.ok(RestResponse.empty());
    }
    
    @RequestMapping(value = "/order", method = RequestMethod.GET)
    public ResponseEntity<RestResponse<PageDto<OrderDto>>> getOrders(Pageable pageable) {
        ...
        return ResponseEntity.ok(RestResponse.of(orderPage));
    }
